...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            intent.putExtra(ProcessInfoContract.ProcessInfoEntry.COLUME_PACKAGE_NAME, mPackageName.getText());
            intent.putExtra(ProcessInfoContract.ProcessInfoEntry.COLUME_CPU_USAGE, mCpuUsageString);
            intent.putExtra(ProcessInfoContract.ProcessInfoEntry.COLUME_MEMORY_USAGE_KB, mMemoryUsageKbString);
            intent.putExtra(ProcessInfoContract.ProcessInfoEntry.COLUME_MEMORY_USAGE_PERCENT, mMemoryUsagePercentString);
